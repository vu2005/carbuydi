...
if (isset($_GET['id'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo '<span class="msg">Xóa tài khoản thành công!</span>';
        echo '</div>';
        echo '<script>';
        echo 'setTimeout(function() {';
        echo '  window.location.href = "index.php?quanly=AccountCustomer";'; // Chuyển hướng về trang sản phẩm
        echo '}, 500);'; // Thời gian chờ trước khi chuyển hướng (3000ms = 3 giây)
        echo '</script>';
    } else {
