<?php
// Truy vấn dữ liệu số lượng xe trong bảng cars có giá từ 700 triệu đến 1 tỷ
$sql_count = "SELECT COUNT(*) AS total FROM cars WHERE price >= 700000000 AND price < 1000000000";
...
echo "<p class='total-cars'>Tổng số lượng xe từ 700 triệu đến 1 tỷ: " . $total_cars . "</p>";
...
$sql = "SELECT 
    ...
    WHERE c.price >= 700000000 AND c.price < 1000000000";
