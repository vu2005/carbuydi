<?php
// Truy vấn dữ liệu số lượng xe trong bảng cars có giá trên 1 tỷ
$sql_count = "SELECT COUNT(*) AS total FROM cars WHERE price >= 1000000000";
...
echo "<p class='total-cars'>Tổng số lượng xe trên 1 tỷ là: " . $total_cars . "</p>";
