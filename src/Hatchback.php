...
// Truy vấn dữ liệu số lượng xe coupe
$sql_count = "SELECT COUNT(*) AS total FROM cars_details WHERE body_style = 'Hatchback'";
$result_count = $conn->query($sql_count);
$row_count = $result_count->fetch_assoc();
$total_coupe_cars = $row_count['total'];

// In ra tổng số lượng xe có kiểu dáng Hatchback
echo "<p class='total-cars'>Tổng số lượng xe có kiểu dáng Hatchback là: " . $total_coupe_cars . "</p>";

// Tiếp tục với việc hiển thị thông tin các xe coupe
