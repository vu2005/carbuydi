<?php
// Truy vấn dữ liệu số lượng xe trong bảng cars có giá từ 500 triệu đến 700 triệu
$sql_count = "SELECT COUNT(*) AS total FROM cars WHERE price >= 500000000 AND price <= 700000000";
...
echo "<p class='total-cars'>Tổng số lượng xe từ 500 triệu đến 700 triệu: " . $total_cars . "</p>";
...
$sql = "SELECT 
    ...
    WHERE c.price >= 500000000 AND c.price <= 700000000";
