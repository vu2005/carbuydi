<?php
// Truy vấn dữ liệu số lượng xe trong bảng cars có giá dưới 500 triệu
$sql_count = "SELECT COUNT(*) AS total FROM cars WHERE price < 500000000";
...
echo "<p class='total-cars'>Tổng số lượng xe dưới 500 triệu: " . $total_cars . "</p>";
