...
$sql_count = "SELECT COUNT(*) AS total FROM cars_details WHERE fuel_type = 'Điện'";
$result_count = $conn->query($sql_count);
$row_count = $result_count->fetch_assoc();
$total_toyota_cars = $row_count['total'];

// In ra số lượng xe Toyota
echo "<p class='total-cars'>Số lượng xe có nhiện liệu điện là: " . $total_toyota_cars . "</p>";
