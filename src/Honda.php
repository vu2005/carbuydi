...
// Truy vấn dữ liệu số lượng xe honda
$sql_count = "SELECT COUNT(*) AS total FROM cars WHERE make = 'honda'";
$result_count = $conn->query($sql_count);
$row_count = $result_count->fetch_assoc();
$total_honda_cars = $row_count['total'];

// In ra số lượng xe honda
echo "<p class='total-cars'>Số lượng xe Honda: " . $total_honda_cars . "</p>";
