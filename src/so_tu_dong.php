...
$sql_count = "SELECT COUNT(*) AS total FROM cars_details WHERE transmission = 'Số tự động'";
$result_count = $conn->query($sql_count);
$row_count = $result_count->fetch_assoc();
$total_coupe_cars = $row_count['total'];

// In ra tổng số lượng xe có kiểu dáng Sedan
echo "<p class='total-cars'>Tổng số lượng xe có hộp Số tự động là: " . $total_coupe_cars . "</p>";
...
$sql = "SELECT 
    ...
    WHERE cd.transmission = 'Số tự động'";
