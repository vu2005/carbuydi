...
// Truy vấn dữ liệu số lượng xe ford
$sql_count = "SELECT COUNT(*) AS total FROM cars WHERE make = 'ford'";
$result_count = $conn->query($sql_count);
$row_count = $result_count->fetch_assoc();
$total_ford_cars = $row_count['total'];

// In ra số lượng xe ford
echo "<p class='total-cars'>Số lượng xe Ford: " . $total_ford_cars . "</p>";
